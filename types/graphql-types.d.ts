...
export type LayoutComponentQueryVariables = {};


export type LayoutComponentQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
export type IndexPageQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: (
    ...
    & { edges: Array<{ node: (
        ...
        & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags'>>, fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
      ) }> }
  ) };

export type MyFilesPageQueryVariables = {};
...
export type TagIndexPageQueryVariables = {
  tag?: Maybe<Array<Scalars['String']>>
};


export type TagIndexPageQuery = { allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id' | 'excerpt'>
        & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags'>>, fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
